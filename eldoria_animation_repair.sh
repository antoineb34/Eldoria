...
replacements = {
    'src/assets/animation/AnimationData.h': ('ec3f56e25a3a43a904a5d361f12072ab968819b78947d611061563804c31453c', r'''#pragma once
...
'''),
    'src/assets/animation/AnimationDecoder.cpp': ('1c95fa31492c5b7c8d4d926a780c4ace7a9aaeadc4eb0494d41796470988e34d', r'''#include "animation/AnimationDecoder.h"
...
AnimationData AnimationDecoder::decode(
    ...
    if (
        ...
        throw std::runtime_error(
            "AnimationData payload is too small"
        );
    }
    ...
    auto section = [&](std::size_t size) {
        if (
            ...
            throw std::runtime_error(
                "AnimationData section exceeds body"
            );
        }
    ...
    if (!skeletonData.atEnd()) {
        throw std::runtime_error(
            "AnimationData skeleton did not consume its section exactly"
        );
    }
    ...
    for (
        ...
        if (
            ...
            throw std::runtime_error(
                "AnimationData frame references more slots than its skeleton owns"
            );
        }
    ...
    if (
        ...
        throw std::runtime_error(
            "AnimationData streams were not consumed exactly"
        );
    }
...
'''),
    'src/assets/animation/AnimationPipeline.h': ('311066bdaff4246179b33a0c463f8919476e5b90705ac0fd7b379665c3de95f6', r'''#pragma once
...
'''),
    'src/assets/animation/AnimationPipeline.cpp': ('bb6b659ee3d3a505d8099c6326abc05ea3218d5c8962ccf28e31271b9ff796ed', r'''#include "animation/AnimationPipeline.h"
...
'''),
    'src/assets/sequence/SequencePipeline.h': ('8611e237947a41afa1cadace4066c5842486bdf900414684da9c81bb137c26c3', r'''#pragma once
...
'''),
    'src/assets/sequence/SequencePipeline.cpp': ('fb17cfcb29c7bf51cf286e515343eb036b1944facbf18d2e8b91c23c8fd53414', r'''#include "sequence/SequencePipeline.h"
...
'''),
    'src/assets/sequence/SequenceResource.h': ('2d1fb0dfe198408871f55e416f759e94a82e4a3fd3c1630bf6103754455575b7', r'''#pragma once
...
'''),
    'src/assets/sequence/SequenceAssembler.h': ('550e426f274c1ae1c2c9785b1455edced8c6aa81d3add2eb318ad95b45848273', r'''#pragma once
...
'''),
    'src/assets/sequence/SequenceAssembler.cpp': ('876999813ee0a19688ebfd7bb387d98d706cc79e78dcf09f492c59ca99a51190', r'''#include "sequence/SequenceAssembler.h"
...
'''),
    'src/runtime/render/animation/AnimationPlayer.cpp': ('250bbfcc8a12f86d522d1dd4f627a05945668713e35e547c380bcc2defdbeb1d', r'''#include "AnimationPlayer.h"
...
'''),
    'src/runtime/render/animation/AnimationPlayer.h': ('378a0a783efcd7750c8f32aeba58dcf15c64db27835fe7bbad534df591922cfd', r'''#pragma once
...
'''),
    'src/runtime/render/animation/ModelAnimator.cpp': ('18d1763d6080ef35949b91ca61bccb95a0fa7f76ae5f82fbe6ad8f618f54f52e', r'''#include "ModelAnimator.h"
...
'''),
    'src/runtime/render/animation/ModelAnimator.h': ('0320bad6b6d305a51aaa593b654ebe1e7f797e5cb5867fcfa06f66bcdfbc9825', r'''#pragma once
...
'''),
    'src/assets/AssetManager.h': ('e83029fb17dc4100c931638fbed707e9ee506537d321942ae7444b4d91f02431', r'''#pragma once
...
'''),
    'src/assets/AssetManager.cpp': ('911236dc4b89293102ac8bd5e0d44fb9c18c3e63f7fa7cd892cc71a126cd6a30', r'''#include "AssetManager.h"
...
'''),
    'src/assets/CMakeLists.txt': ('de94d5434efeafe46cd6520dcafdf466d6b870bf3b0119223e853fe75acb58f1', r'''add_library(eldoria_assets STATIC
    AssetManager.cpp
    ...
    texture/TexturePipeline.cpp
    sprite/SpriteAssembler.cpp
    sprite/SpritePipeline.cpp
)
...
'''),
    'src/assets/repositories/SpotAnimationRepository.h': ('19e6eb388012b10c74ff67c5b9fbc75a23459e4c1d4d353a862fa4efea22d37c', r'''#pragma once
...
'''),
    'src/assets/repositories/SpotAnimationRepository.cpp': ('eafdd916e36780ea9da9e0ed280727d9819ebbc4e0559820a29e3f45777e80e2', r'''#include "repositories/SpotAnimationRepository.h"
...
'''),
    'src/assets/repositories/MessageAnimationRepository.h': ('20a8825c5b25d39f138aeaf15114fc01ef7425b65e435ccccf0e89175960a3cc', r'''#pragma once
...
'''),
    'src/assets/repositories/MessageAnimationRepository.cpp': ('639e3fcba27fb3520f69a1f6b200796091230ec90ee547cd30cb8711a194d365', r'''#include "repositories/MessageAnimationRepository.h"
...
'''),
    'src/apps/elforge/explorer/CacheExplorer.h': ('df74efde67d1f362c8bb05b7b790b57042ad67d3f59acc6e32e742c559c1917c', r'''#pragma once
...
'''),
    'src/apps/elforge/explorer/CacheExplorer.cpp': ('e9de4160ab53e41ee54c7c11c95f5c6e897f72581825c32626c7c7aee44914b6', r'''#include "ui/ElForgeTheme.h"
...
CacheExplorer::CacheExplorer()
    : cache_("cache"),
      ...
      animationFrameTable_(animationPipeline_),
      animationPlayer_(),
      animationPresentationCatalog_(
      ...
      titleSpritePipeline_(cache_, eld::sprite::SpriteArchive::Title),
      mediaSpritePipeline_(cache_, eld::sprite::SpriteArchive::Media),

      titlePipeline_(cache_),
...
'''),
    'src/apps/elforge/explorer/CacheExplorerAnimation.cpp': ('d3d7991c9fd12df5ca93e008f8858676ca89ae2314978f11acb8bd77bc13c953', r'''#include "ui/ElForgeTheme.h"
#include "explorer/CacheExplorer.h"
...
bool CacheExplorer::activateAnimationPreviewUse(
    ...
    const auto sequence =
        sequencePipeline_.find(
            use.sequenceId
        );

    if (
        !sequence ||
        sequence->data.frames.empty()
    ) {
...
void CacheExplorer::appendActionEffects(
    ...
    for (
        ...
        if (definition->sequenceId.has_value()) {
            const auto sequence =
                sequencePipeline_.find(*definition->sequenceId);
...
'''),
    'src/apps/elforge/inspection/AnimationInspector.h': ('00578f4c0d24a5228ae1dc80c56c5a559475e37b10614dd7517f28c97517982e', r'''#pragma once
...
public:
    AnimationInspector(
        ...
        const eld::sequence::SequencePipeline& sequences,
...
private:
    const eld::animation::AnimationPipeline* animations_ = nullptr;
    const eld::sequence::SequencePipeline* sequences_ = nullptr;
...
'''),
    'src/apps/elforge/inspection/AnimationInspector.cpp': ('26e1ad601448b73fad73c1bc0521a6e1dec7fd1eaf0c130be25ad60fc138e078', r'''#include "animation/AnimationPlayer.h"
...
'''),
    'src/assets/animation/AnimationFrameResource.h': (None, r'''#pragma once
...
'''),
    'src/assets/animation/AnimationFrameTable.h': (None, r'''#pragma once
...
'''),
    'src/assets/animation/AnimationFrameTable.cpp': (None, r'''#include "animation/AnimationFrameTable.h"
...
def transform(name, text):
    for old, new in (
        ('SpotAnimationPipeline', 'SpotAnimationRepository'),
        ('MessageAnimationPipeline', 'MessageAnimationRepository'),
        ('spotAnimationPipeline_', 'spotAnimationRepository_'),
        ('messageAnimationPipeline_', 'messageAnimationRepository_'),
        ('AnimationFrameView', 'AnimationFrameResource'),
        ('AnimationFrame', 'AnimationFrameData'),
    ):
        text = re.sub(r'\b' + re.escape(old) + r'\b', new, text)
    if not name.startswith('src/assets/sequence/'):
        text = re.sub(
    ...
    if ('AnimationFrameResource' in text
            and name != 'src/assets/animation/AnimationFrameResource.h'
            and '#include "animation/AnimationFrameResource.h"' not in text):
        text = text.replace('#include "animation/AnimationData.h"',
            '#include "animation/AnimationData.h"\n#include "animation/AnimationFrameResource.h"')
    return text
...
for name, (expected, replacement) in replacements.items():
    path = Path(name)
    if path.is_symlink():
        raise SystemExit(f"Refusing to replace symlink: {name}; no files changed.")
    if path.exists():
        current = path.read_text()
        if normalized(current) == normalized(replacement):
            continue
        digest = hashlib.sha256(normalized(current).encode()).hexdigest()
        if expected is None or digest != expected:
            raise SystemExit(f"File differs from the uploaded version: {name}; no files changed.")
    elif expected is not None:
        raise SystemExit(f"Missing {name}; no files changed.")
...
for path in Path('src').rglob('*'):
    ...
    if name in replacements:
        continue
    current = path.read_text()
    updated = transform(name, current)
    if updated != current:
        updates[name] = updated

if updates:
    backup = Path(tempfile.mkdtemp(prefix='eldoria-animation-repair-backup.', dir=Path.cwd()))
    for name in updates:
        path = Path(name)
        if path.exists():
            saved = backup / name
    ...
    (backup / 'created-files.txt').write_text(''.join(name + '\n' for name in updates if not Path(name).exists()))
    ...
    print('Repair already applied; checking the build.')
PY_REPAIR

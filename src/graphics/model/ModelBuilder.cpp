...
using eld::render::AlphaMode;
using eld::render::ModelResource;
using eld::render::RenderMaterial;
using eld::render::RenderMesh;
using eld::render::RenderMeshSection;
using eld::render::TextureAddressMode;
using eld::render::TextureFilter;
using eld::render::TextureHandle;
...
ModelResource ModelBuilder::build(
    const eld::model::ModelData& source
) {
    ModelResource model;
    RenderMesh mesh;

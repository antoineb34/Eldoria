...
void appendTriangle(
    RenderBucket& bucket,
    eld::render::RenderVertex a,
    eld::render::RenderVertex b,
    eld::render::RenderVertex c
) {
...
eld::render::RenderModel finishBuckets(
    std::vector<RenderBucket> buckets
) {
...
eld::render::RenderMaterial terrainMaterial(
...
eld::render::RenderVertex transformLocVertex(

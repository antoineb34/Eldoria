...
constexpr bool hasTileFlag(std::uint8_t settings, TileFlag flag) {
...
constexpr std::size_t tileIndex(std::size_t plane, std::size_t x,
                                std::size_t y) {
  return plane * RegionSize * RegionSize + x * RegionSize + y;
}

...
struct ItemData {
  ...
  std::array<std::optional<std::uint16_t>, 3> maleModelIds;

  std::array<std::optional<std::uint16_t>, 3> femaleModelIds;

  std::int8_t maleModelOffset = 0;
  std::int8_t femaleModelOffset = 0;

  std::array<std::optional<std::uint16_t>, 2> maleHeadModelIds;

  std::array<std::optional<std::uint16_t>, 2> femaleHeadModelIds;

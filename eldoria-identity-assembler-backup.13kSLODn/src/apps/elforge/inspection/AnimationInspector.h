...
public:
  ...
  AnimationInspection inspect(std::uint16_t animationId) const;
...
private:
  ...
  const eld::npc::NpcLoader *npcs_ = nullptr;
  const eld::location::LocationLoader *locations_ = nullptr;
  const eld::spot_animation::SpotAnimationLoader *spotAnimations_ = nullptr;
  const eld::item::ItemLoader *items_ = nullptr;
  const eld::interface::WidgetLoader *interfaces_ = nullptr;
  const eld::animation::presentation::AnimationPresentationCatalog
